			...
			<?php 
				...
				while($p=mysqli_fetch_array($periksa_bahan)){	
					if($p['stock']<=1){	
						...
						<?php
						echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok  <strong><u>".$p['tanggal']. "</u> <u>".($p['nama'])."</u> &nbsp <u>".$p['stock']."</u></strong> yang tersisa sudah habis</div>";		
					}
				}
				?>
